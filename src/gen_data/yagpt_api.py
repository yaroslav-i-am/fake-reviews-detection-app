...
for i in range(3800):
    prompt = {
        ...
        "messages": [
            {
                "role": "system",
                "text": "Какой бы" + emotion[rd.randint(0, 2)] + "отзыв ты бы оставил? Отзыв должен быть не больше 30 символов. Ответ дай в виде json-файла. Проверяй отзыв на логичность и естественность. Не начинай отзыв со слов 'Купил' или 'Купила'" 
            },
            {
                "role": "user",
