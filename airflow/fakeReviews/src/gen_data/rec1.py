...
class RecFakeReviews:
    def __init__(self):
        ...
        self.queue = pd.read_pickle(s3_hook.download_file(key="data/ids1.pkl", bucket_name="fake-reviews"))
    ...
    def parse(self):    
        ...
        s3_hook.load_bytes(pickle_feedbacks_obj, "data/feedbacks1.pkl", bucket_name="fake-reviews", replace=True)
